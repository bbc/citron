...
"""
This application trains and/or evaluates a Citron Content Classifier.
"""

import argparse
import logging

from citron.content import ContentClassifier
...
def main():
    parser = argparse.ArgumentParser(
        description="Build and/or evaluate a Content Classifier model",
    ...
    if args.train_path:
        ContentClassifier.build_model(nlp, args.train_path, args.model_path)
        
    if args.test_path:
        content_classifier = ContentClassifier(args.model_path)
        content_classifier.evaluate(nlp, args.test_path)
