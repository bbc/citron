...
"""
This application trains and/or evaluates a Citron Source Resolver.
"""

import argparse
import logging

from citron.source import SourceResolver
...
def main():
    parser = argparse.ArgumentParser(
        description="Build and/or evaluate a SourceResolver model",
    ...
    if args.train_path:
        SourceResolver.build_model(nlp, args.train_path, args.model_path)
    
    if args.test_path:
        source_resolver = SourceResolver(args.model_path)
        source_resolver.evaluate(nlp, args.test_path)
